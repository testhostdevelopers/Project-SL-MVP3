                                                    ...
                                                    <div className="col-sm-12 col-lg-4 mb-4 activity-number-card-right">
                                                        <div className="filters-listing-reset">
                                                            ...
                                                            <div className="filters-listing-button-list">
                                                                <button className="btn-light mr-2 mt-2 bg-white active" onClick={(val) => findFilter('listing')}>
                                                                ...
                                                                <button className="btn-light mr-2 mt-2 bg-white"  onClick={() => findFilter('purches')}>
                                                                ...
                                                                <button className="btn-light mr-2 mt-2 bg-white" onClick={() => findFilter("sales")}>
                                                                ...
                                                                <button className="btn-light mr-2 mt-2 bg-white" onClick={() => findFilter("transfer")}>
                                                                ...
                                                                <button className="btn-light mr-2 mt-2 bg-white" onClick={() => findFilter("burn")}>
                                                                ...
                                                                <button className="btn-light mr-2 mt-2 bg-white" onClick={() => findFilter("bids")}>
                                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <button className="btn-light mr-2 mt-2 bg-white" onClick={() => Setlisting("Likes")}>
                                                                ...
                                                                <button className="btn-light mr-2 mt-2 bg-white" onClick={() => Setlisting("Followings")}>
