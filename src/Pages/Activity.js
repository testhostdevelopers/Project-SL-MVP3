                                                    ...
                                                    <div className="col-sm-12 col-lg-4 mb-4 activity-number-card-right">
                                                        <div className="filters-listing-reset">
                                                            ...
                                                            <div className="filters-listing-button-list">
                                                                ...
                                                                <button className={`btn-light mr-2 mt-2 bg-white ${listing === 'Purchases' ? 'active' : ''}`}  onClick={() => findFilter('Purchases')}>
                                                                ...
                                                                <button className={`btn-light mr-2 mt-2 bg-white ${listing === 'Sales' ? 'active' : ''}`} onClick={() => findFilter("Sales")}>
                                                                ...
                                                                <button className={`btn-light mr-2 mt-2 bg-white ${listing === 'Transfer' ? 'active' : ''}`} onClick={() => findFilter("Transfer")}>
                                                                ...
                                                                <button className={`btn-light mr-2 mt-2 bg-white ${listing === 'Burn' ? 'active' : ''}`} onClick={() => findFilter("Burn")}>
                                                                ...
                                                                <button className={`btn-light mr-2 mt-2 bg-white ${listing === 'Bids' ? 'active' : ''}`} onClick={() => findFilter("Bids")}>
                                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <button className={`btn-light mr-2 mt-2 bg-white ${listing === 'Likes' ? 'active' : ''}`} onClick={() => Setlisting("Likes")}>
                                                                ...
                                                                <button className={`btn-light mr-2 mt-2 bg-white ${listing === 'Followings' ? 'active' : ''}`} onClick={() => Setlisting("Followings")}>
