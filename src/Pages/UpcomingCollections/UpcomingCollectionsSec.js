                ...
                <div className="upcoming-collections-box">
                    ...
                    <div className="upcoming-collections-info-box">
                        ...
                        <ul className="upcoming-soon-collections-count-list">
                            <li>4<span>Days</span></li>
                            <li>5<span>Hours</span></li>
                            <li>43<span>Minutes</span></li>
                            <li>25<span>Seconds</span></li>
                        </ul>
                        <a href="#0" className="add-to-calendar-btn">Add to calendar</a>
                    </div>
                </div>
                <div className="upcoming-collections-box">
                    <div className="upcoming-collections-img">
                    ...
                    <div className="upcoming-collections-info-box">
                        ...
                        <p>A collection of 8,888 unique generative NFTs from an other universe. </p>
                        <div className="upcoming-collections-time">
                            <span>1 January 2021</span>
                            <span>5pm GMT</span>
                        </div>
