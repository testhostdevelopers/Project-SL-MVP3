  ...
  return (
    <>
        ...
        <div className="cryptoioria-banner-container">
          <div className="position-absolute text-center d-flex flex-column">
            ...
            <div className="pl-4 pr-4">
              The enchanted universe of Cryptoloria in partnership with
              Starlight Exclusive NFT collection drops
            </div>
          ...
          <div className="row mt-5">
            ...
            <div className="col-sm-12 col-md-7 col-lg-7 home-artwork-week-day position-relative d-flex flex-column align-items-stretch justify-content-between">
              <div className="d-flex overflow-auto justify-content-between w-100 justify-content-between">
                <ArtWork
                  title="Butterfly"
                  artworkimg={artWorkWeek1}
                  setOpenImage={(imgFlag) => setOpenImage(imgFlag)}
                />
                <ArtWork
                  title="Butterfly"
                  artworkimg={artWorkWeek2}
                  setOpenImage={(imgFlag) => setOpenImage(imgFlag)}
                />
                <ArtWork
                  title="Butterfly"
                  artworkimg={artWorkWeek3}
                  setOpenImage={(imgFlag) => setOpenImage(imgFlag)}
                />
                <ArtWork
                  title="Butterfly"
                  artworkimg={artWorkWeek4}
                  setOpenImage={(imgFlag) => setOpenImage(imgFlag)}
                />
                <ArtWork
                  title="Butterfly"
                  artworkimg={artWorkWeek5}
                  setOpenImage={(imgFlag) => setOpenImage(imgFlag)}
                />
                <ArtWork
                  title="Butterfly"
                  artworkimg={artWorkWeek6}
                  setOpenImage={(imgFlag) => setOpenImage(imgFlag)}
                />
              </div>
            </div>
        ...
        <div className="container-fluid">
          ...
          <div className="topSellerContent mt-5">
            <div className="d-flex">
              ...
              />
              <TopCard
                topcoverimg={topSeller5}
                topuserimg={topSellerUser5}
                title="Savannah Nguyen"
                Price="$1,403"
              />
              <TopCard
                topcoverimg={topSeller6}
                topuserimg={topSellerUser6}
                title="Devon Lane"
                Price="$1,403"
              />
              <TopCard
                topcoverimg={topSeller7}
                topuserimg={topSellerUser7}
                title="Arlene McCoy"
                Price="$1,403"
              />
              <TopCard
                topcoverimg={topSeller8}
                topuserimg={topSellerUser8}
                title="Albert Flores"
                Price="$1,403"
              />
              <TopCard
                topcoverimg={topSeller9}
                topuserimg={topSellerUser9}
                title="Kristin Watson"
                Price="$1,403"
              />
              <TopCard
                topcoverimg={topSeller10}
                topuserimg={topSellerUser10}
                title="Cody Fisher"
                Price="$1,403"
              />
            </div>
      ...
      <motion.section
        ...
        animate="visible"
        variants={variants}
        className="liveAuction live-auction-none-mobile proile-liked-filter cryptoloria-hidden-bids"
      >
        <div className="container-fluid">
          <div className="w-100 d-flex justify-content-between align-items-center">
            <h3>
      ...
      <motion.section
        ...
        animate="visible"
        variants={variants}
        className="liveAuction-web-none cryptoloria-hidden-bids liveAuction"
      >
        <div className="container-fluid">
          <div className="w-100">
            <h3>
      ...
      <motion.section
        ...
        animate="visible"
        variants={variants}
        className="liveAuction live-auction-none-mobile hot-bids-liveAuction"
      >
        <div className="container-fluid">
          <div className="w-100 d-flex justify-content-between align-items-center">
            <h3>
