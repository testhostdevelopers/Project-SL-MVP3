        ...
        <div className="the-starlight-first-block">
          <div className="row">
            <div className="the-starlight-first-left-block">
              ...
              <p className="text">
                If you made a sale or a purchase last week, you've got some $SLX
                rewards to claim!
              </p>
            </div>
        ...
        <div className="the-starlight-second-block">
          <div className="row">
            <div className="the-starlight-howit-left-block">
              ...
              <p className="text">
                $STARLIGHT rewards distribution on Starlight.com is a part of
                Starlight Protocol DAO App Mining program and is calculated
                dynamically each week.
              </p>
            </div>
