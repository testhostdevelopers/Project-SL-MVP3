    ...
    >
      <div className="border-radius bg-white popup-width">
        ...
        <p className="sub-heading">
          Metamask Message Signature: User denied message signature. If the
          problem persist please <strong>contact support.</strong>
        </p>

        <div className="">
          <button className="btn-ping w-100 mt-4">Try again</button>
        </div>
      </div>
    </motion.div>
  );
