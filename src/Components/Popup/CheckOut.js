        ...
        <>
            <motion.div
                ...
                <div className="border-radius bg-white popup-width">
                    ...
                    <small className="sub-heading">You are about to purchase: <br /> <b>Burning peace</b> by <b>OGwin</b></small>

                    <Tabs selectedIndex={tabIndex} onSelect={index => setTabIndex(index)} className="checkout-tab mt-4">
                       <div className="tab-nav">
                        ...
                        <div className="tab-content">
                            <TabPanel>
                                <h5 className="mt-3"><b>You pay</b></h5>
                            ...
                            <TabPanel>
                                <h5 className="mt-3"><b>You pay</b></h5>
                                <div className="pt-2 pb-2 border-bottom d-flex justify-content-between bid-input">
                                    <input type="text" className="formcontrol" placeholder="≈ 166.2"/>
                                    {/* <div>0.2</div> */}
                                    <div className="info">
