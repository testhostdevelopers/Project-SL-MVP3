      ...
      >
        <div className="border-radius bg-white popup-width">
          ...
          <small className="sub-heading">
            You are about to purchase: <br /> <b>Burning peace</b> by{" "}
            <b>OGwin</b>
          </small>
              ...
              <TabPanel>
                ...
                <div className="pt-2 pb-2 border-bottom d-flex justify-content-between bid-input">
                  ...
                  <div className="info">
                    <span
                      className="help"
                      onClick={() => props.sethelpPopup(true)}
                    >
                      <svg
                        width="18"
                        height="17"
                    ...
                    <div className="dropdown-menu popup-inner-dropdown-menu">
                      <ul className="menu-dropdown">
                        {options.map((v, i) => (
                          <li key={i} onClick={() => setSelected(v.value)}>
                            {v.label}
                          </li>
                        ))}
                        {/* <li>ETH</li> */}
