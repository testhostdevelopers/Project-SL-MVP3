    ...
    >
      <div className="follow-step border-radius bg-white popup-width">
          ...
          <div className="d-flex">
            ...
            <div className="ml-3">
              ...
              <p className="color-gray">
                <small>
                  Send transaction to convert <b>ETH to wETH</b>
                </small>
              </p>
            </div>
          </div>

          <button className="btn-gray  w-100 mb-3">Completed</button>
        </div>
        ...
        <div className="mb-3">
          ...
          <button className="btn-ping w-100 mb-3">Start</button>
        </div>
        ...
        <button
          className="btn-primary-outline w-100 mb-3"
          onClick={() => {
